...
World.prototype.load = function() {
	...
	request.open("GET", "./assets/world_plane.obj");
	...
	var handleLoadedWorld = function(data) {
	  ...
	  world.vertexPositionBuffer.numItems = vertexCount;
	  ...
	  world.vertexIndexBuffer.numItems = indexCount;
